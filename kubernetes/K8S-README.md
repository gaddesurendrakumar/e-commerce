...
```
$ docker image tag invoice gaddesurendrakumar/invoice
$ docker push gaddesurendrakumar/invoice
$ docker image tag notification gaddesurendrakumar/notification
$ docker push gaddesurendrakumar/notification
$ docker image tag store gaddesurendrakumar/store
$ docker push gaddesurendrakumar/store
```
